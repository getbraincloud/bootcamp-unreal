# BootCamp-Unreal (Lesson 03 - UE 4.27)

This repository contains the Unreal project for Lesson 03 that is used for the brainCloud BootCamp learning series.
...
The example Unreal project in this repository contains the final code that was modified in Lesson 03 of the brainCloud BootCamp learning series. In this lesson, the brainCloud client was added the example Unreal project.
