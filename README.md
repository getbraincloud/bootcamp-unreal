# BootCamp-Unreal (Lesson 10 - UE 4.27)

This repository contains the Unreal project for Lesson 10 that is used for the brainCloud BootCamp learning series.
...
The example Unreal project in this repository contains the final code that was modified in Lesson 10 of the brainCloud BootCamp learning series. In this lesson, the example Unreal project is updated to support Email authentication (email + password).
