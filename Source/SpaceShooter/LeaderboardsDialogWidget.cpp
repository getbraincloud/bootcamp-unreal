...
bool ULeaderboardsDialogWidget::Initialize()
{
    ...
    if(SegmentControlMiddle)
        SegmentControlMiddle->OnClicked.AddUniqueDynamic(this, &ULeaderboardsDialogWidget::OnMiddleSegmentButtonClicked);
...
void ULeaderboardsDialogWidget::SetSegmentControlState(SegmentControlState segmentControlState)
{
    ...
    FString middleTexture = GetTexturePath(SegmentControlState::Daily);
    FString rightTexture = GetTexturePath(SegmentControlState::Country);

    SetButtonTextures(SegmentControlLeft, leftTexture, segmentControlState == SegmentControlState::Main);
    SetButtonTextures(SegmentControlMiddle, middleTexture, segmentControlState == SegmentControlState::Daily);
    SetButtonTextures(SegmentControlRight, rightTexture, segmentControlState == SegmentControlState::Country);
}
...
void ULeaderboardsDialogWidget::OnMiddleSegmentButtonClicked()
{
...
void ULeaderboardsDialogWidget::OnRightSegmentButtonClicked()
{
    ...
    SetLeaderboardData(kBrainCloudCountryLeaderboardID);
}
