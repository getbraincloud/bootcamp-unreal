...
static const FString kBrainCloudDailyLeaderboardID = "Daily";
static const FString kBrainCloudCountryLeaderboardID = "Country";
...
static const FString kBrainCloudExternalAuthTwitch = "TwitchAuthentication";
static const FString kBrainCloudCountryLeaderboardEntityType = "countryLeaderboard";

// Twitch constants
static const FString kTwitchAuthUrl = "https://id.twitch.tv/oauth2/authorize";
static const FString kTwitchClientId = ""; // Twitch clientID is empty on purpose
static const FString kTwitchClientSecret = ""; // Twitch clientSecret is empty on purpose
static const FString kTwitchRedirectHostAndPort = "localhost:3030";
static const FString kTwitchRedirectUrl = "http://" + kTwitchRedirectHostAndPort + "/";
